...
gomoku = __import__("jessy_gomoku") #put your filename here (pls for the love of god run this shit in the same folder as your file (and for the love of jesus do not pyzo this))
...
class client(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        analysis.pack(padx = 20, pady = 2)
        special = Button(self, text = "SPECIAL!", command = self.special_cases)
        special.pack(padx = 20, pady=  2)
    ...
    def special_cases(self):
        ...
        self.analyze(board = case_1, special = True)

    def analyze(self, board = [], special = False):
